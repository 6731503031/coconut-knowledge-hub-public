...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2025 at 10:25 PM
...
CREATE TABLE `price` (
  `date` date NOT NULL,
  `central_price` decimal(10,2) DEFAULT NULL,
  `northeast_price` decimal(10,2) DEFAULT NULL,
  `south_price` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('P-CO-001', 'P-CO-001', 150.00, '2025-11-14 15:41:49', 'Fresh', NULL, 1.5, NULL, NULL, NULL),
('P-FR-002', 'P-FR-002', 35.00, '2025-11-14 15:41:49', 'Processed', NULL, NULL, NULL, NULL, NULL);
...
('U-63071f6d-4340-467a-b0a4-395ea5173a95', 'สมชาย ตัวอย่าง', 'me+entrepreneur@example.com', '$2a$10$tX73JvGNAz8hOPIzCkT9FePVjorsuacKzUQ0kYqdaGhXsHedLV1DK', '0812345678', 'ชุมพร', '2025-11-15 21:02:47.000000', 'Active', 'Entrepreneur'),
